...
function ready()
{
    let overlays= Array.from(document.getElementsByClassName('overlay-text'));// got all the class names of overlay-text which is at restart, start and victory
    let cards=Array.from(document.getElementsByClassName('card'));
    let game =new Memory(60,cards);

    overlays.forEach(overlay => {//started a loop
...
if(document.readyState === 'loading') // to reload
{
